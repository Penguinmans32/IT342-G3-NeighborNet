...
const YourItems = () => {
  ...
  const fetchYourItems = async () => {
    try {
      const response = await fetch("https://neighbornet-back-production.up.railway.app/api/borrowing/items/user", {
        headers: {
  ...
  const fetchLentItems = async () => {
    try {
      const response = await fetch("https://neighbornet-back-production.up.railway.app/api/borrowing/items/lent", {
        headers: {
          Authorization: `Bearer ${localStorage.getItem("token")}`,
        },
      });
  ...
  const fetchBorrowers = async (itemId) => {
    try {
      const response = await fetch(`https://neighbornet-back-production.up.railway.app/api/borrowing/items/${itemId}/borrowers`, {
        headers: {
          Authorization: `Bearer ${localStorage.getItem("token")}`,
        },
      })
