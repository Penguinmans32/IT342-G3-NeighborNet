...
const AdminLogin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
        const response = await axios.post('https://it342-g3-neighbornet.onrender.com/api/admin/login', {
            username: email,
            password: password
        });
        ...
        if (response.data.success) {
          ...
          const userResponse = await axios.get('https://it342-g3-neighbornet.onrender.com/api/auth/user');
