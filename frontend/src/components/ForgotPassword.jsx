...
const ForgotPassword = () => {
  ...
  const handleResendOtp = async () => {
    ...
    try {
      const response = await fetch('https://neighbornet-back-production.up.railway.app/api/auth/password/forgot?email=' + encodeURIComponent(email), {
        method: 'POST',
      });
  ...
  const handleEmailSubmit = async (e) => {
    ...
    setIsLoading(true);
    try {
        const response = await fetch(`https://neighbornet-back-production.up.railway.app/api/auth/check-provider?email=${encodeURIComponent(email)}`, {
            method: 'GET',
        });
        ...
        const resetResponse = await fetch('https://neighbornet-back-production.up.railway.app/api/auth/password/forgot?email=' + encodeURIComponent(email), {
            method: 'POST',
        });
  ...
  const handleOtpSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`https://neighbornet-back-production.up.railway.app/api/auth/password/verify-otp?email=${encodeURIComponent(email)}&otp=${otpValue}`, {
        method: 'POST',
      });
  ...
  const handlePasswordSubmit = async (e) => {
    ...
    setIsLoading(true);
    try {
      const response = await fetch('https://neighbornet-back-production.up.railway.app/api/auth/password/reset', {
        method: 'POST',
        headers: {
