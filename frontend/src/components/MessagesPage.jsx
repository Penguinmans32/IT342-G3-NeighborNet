...
const MessagesPage = () => {
  ...
  const handleContactSelect = async (contact) => {
    ...
    try {
      ...
      const response = await fetch(`https://neighbornet-back-production.up.railway.app/messages/read/${contact.id}/${user.data.id}`, {
        method: "PUT",
        headers: {
...
const fetchConversations = async () => {
  ...
  try {
      setLoading(true)
      const response = await fetch(`https://neighbornet-back-production.up.railway.app/conversations/${user.data.id}`)
